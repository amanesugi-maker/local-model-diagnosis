# 軸「実作業」（旧「実作業のコード」・2026-09-08 本人指示①）。実際の依頼文10本→返ってきたコードを隠しテストで採点。
...
# L2（2026-09-08 21:46 本人指示「難易度を上げて。ここが一番大事」）: 仕様に境界・例外・状態が絡む10本。heretic 27B が 18/20 だったので L3（code_tasks_l3.py）を既定にした
TASKS_L2 = [
...
from code_tasks_l3 import TASKS_L3   # L3 = 既定（2026-09-08 21:55 本人指示「エージェント課題の L2/L3 並みに」）
TASKS = TASKS_L3
LEVEL = 3
