...
SECTIONS = [
 ("文学・小説", [
  ...
  ("「国境の長いトンネルを抜けると雪国であった。」で始まるのは（　）。", ["雪国", "伊豆の踊子"], 1),
  ("『羅生門』『鼻』を書いたのは（　）。", ["芥川龍之介", "太宰治"], 1),
 ...
 ("語彙・表記", [
  ...
  # 2026-09-15 分野方式へ移行するため増量（3問では分野として成立しない）
  ("「情けは人の為ならず」の本来の意味は（　）。",
   ["人に情けをかければ巡って自分に返る", "情けをかけるとその人のためにならない"], 1),
  ("「役不足」の本来の意味は（　）。", ["力量に対して役目が軽すぎる", "力量が役目に足りない"], 1),
  ("「檄を飛ばす」の本来の意味は（　）。", ["自分の主張を広く知らせる", "励まして気合いを入れる"], 1),
 ...
 ("敬語", [
  ...
  # 2026-09-15 分野方式へ移行するため増量（1問では分野として成立しない）
  ("取引先に自社の部長の発言を伝えるなら（　）。",
   ["部長が申しております", "部長がおっしゃっています"], 1),
  ("「拝見する」は（　）。", ["謙譲語", "尊敬語"], 1),
  ("客に見てほしいと頼むなら（　）。", ["ご覧ください", "拝見してください"], 1),
  ("「ご覧になられる」は（　）。", ["二重敬語", "正しい尊敬語"], 1),
  ("目上の人に知っているかを尋ねるなら（　）。", ["ご存じですか", "存じていますか"], 1),
  ("自分が行くことを取引先に言うなら（　）。", ["伺います", "参られます"], 1),
 ]),
