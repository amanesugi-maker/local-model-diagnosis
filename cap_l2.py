# L2 課題（2026-09-08 本人決裁「L2 新しく作成」）。設計 = 申し送り §12 の L2 案。
#
...
def required_calls(t: dict) -> set[str]:
    """やるべき呼び出し（道具:引数）。完遂度＝これをやり切った率（L1 の profile_model と同じ定義・2026-09-08 08:44 本人指摘で修正）。
...
def answered(t: dict, x: dict) -> bool:
    """回答率（2026-09-08 12:18 本人決定・旧「完遂」）: 必要な道具を全部呼んだうえで答えを出したか。正誤は問わない。
